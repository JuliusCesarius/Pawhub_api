...
namespace blastic.pawhub.api.Models.Helpers
{
    public class PushServiceHelper
    {
        ...
        internal string SendGCMNotification(string apiKey, string postData, string postDataContentType = "application/json")
        {   
            ...
            {
                return "PUSH Error: " +  e.Message.ToString();    
            }
